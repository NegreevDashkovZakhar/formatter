...
/**
 * Command writing text after paragraph with decreased depth
 */
public class DecreaseParagraphTextCommand implements IFormatterCommand {
     ...
     */
    public DecreaseParagraphTextCommand(final IToken token, final IFormatWriter writer) {
